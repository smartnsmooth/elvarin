...
// Phase 1: globals.css additions
const globalsPath = path.join(root, "src/app/globals.css");
let globals = fs.readFileSync(globalsPath, "utf8");
if (!globals.includes("--primary-dark")) {
...
.hero-gradient {
  background: linear-gradient(135deg, var(--primary-dark) 0%, var(--primary) 55%, #1d4ed8 100%);
}
`;
...
write("src/lib/visuals.ts", `import { siteImage } from "./site-image";
...
write("scripts/download-portfolio-images.mjs", `import fs from "fs";
import path from "path";
...
const images = {
  "images/hero/home.png": "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1600&q=80",
  "images/hero/about.png": "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600&q=80",
  "images/hero/services.png": "https://images.unsplash.com/photo-1551434678-e076c223a692?w=1600&q=80",
  ...
  "images/industries/finance-banking.png": "https://images.unsplash.com/photo-1611974788455-9c2a0a7236a3?w=1600&q=80",
